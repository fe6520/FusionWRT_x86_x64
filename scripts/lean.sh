...
# Modify default IP
sed -i 's/192.168.1.1/192.168.125.17/g' package/base-files/files/bin/config_generate
...
sed -i '/uci commit system/i\uci set system.@system[0].hostname='QWrt'' package/lean/default-settings/files/zzz-default-settings
sed -i "s/OpenWrt /Q /g" package/lean/default-settings/files/zzz-default-settings
